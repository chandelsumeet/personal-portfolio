...
import typescriptImg from "../../assests/images/typescript.png";
    ...
    <>
      <div className="profile-card">
        ...
        <div className="profile-content">
          ...
          <h3>
            ...
            Delhi , India. I am currently working at CES Limited.
          </h3>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="card-container">
          <div className="card">
            <img
              src="https://media.licdn.com/dms/image/C510BAQGBKEUZHfHrVg/company-logo_200_200/0/1556099954566?e=2147483647&v=beta&t=CloDq7v3--282G9iHTJvQpz4CX4XUi1m9_wmx5BUYlw"
              alt=""
            />
            <div className="card-content">
              <p className="company-heading">CES Limited</p>
              <p>01/04/2022 - Present</p>
              <p>
                Responsible for creating frontend application with ReactJs ,
                Redux and Typescript , Material UI
              </p>
            </div>
          </div>
          <div className="card">
      ...
      <div className="download-resume-container">
        <div className="heading-skills">
          <p>
            Want To Know More About Me <strong>Click Below !!</strong>
          </p>
        </div>
        <a href="resume/resume.pdf" download>
          <img src={resumeImg} alt="download" />
        </a>
      </div>
    </>
  );
